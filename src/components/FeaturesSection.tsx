...
const features = [
  ...
  },
  {
    ...
    glow: 'rgba(11,196,227,0.15)',
    border: 'rgba(11,196,227,0.3)',
  },
  {
    icon: BarChart3,
...
function FeatureCard({
  ...
  return (
    <motion.div
      ...
      className="group relative p-6 rounded-sm"
      style={{
    ...
    >
      ...
      {/* Icon */}
      <div
        className="relative z-10 w-12 h-12 rounded-sm mb-5 flex items-center justify-center"
      ...
      {/* Content */}
      <h3 className={`relative z-10 font-cinzel font-bold text-lg mb-3 ${feature.color}`}>
        {feature.title}
      </h3>
      <p className="relative z-10 font-rajdhani text-gold-light/55 leading-relaxed text-[15px]">
        {feature.description}
      </p>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div ref={titleRef} className="text-center mb-20">
          ...
          >
            ...
            <span className="font-rajdhani text-xs tracking-[0.3em] uppercase text-gold/60">
              Funcionalidades
            </span>
            <div className="h-px w-8 bg-gold/50" />
          </motion.div>
          ...
          >
            ...
            <span className="text-gold">SUBIR DE ELO</span>
          </motion.h2>
